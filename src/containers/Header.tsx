    ...
    return (
        <section id="header">
            <div className=' flex flex-col items-center justify-center  p-3 h-80v top-0'>
                ...
                <h3 className='lg:text-3xl py-2 text-2xl text-gray-400 '> Software Developer And Explorer</h3>
                <p className='lg:text-xl py-5 leading-8 text-base max-w-md text-gray-400'> I would tell you UDP joke, but you might not get it!!</p>
